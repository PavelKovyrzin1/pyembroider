...
transformed_color_data = {(Brands.DMC.value, 'B5200'): {'name': 'Snow White', 'code': 'B5200', 'rgb': (255, 255, 255)},
                          ...
                          (Brands.DMC.value, '822'): {'name': 'Light Beige Gray', 'code': '822', 'rgb': (231, 226, 211)},
                          (Brands.DMC.value, '644'): {'name': 'Medium Beige Gray', 'code': '644', 'rgb': (221, 216, 204)},
                          (Brands.DMC.value, '642'): {'name': 'Dark Beige Gray', 'code': '642', 'rgb': (196, 190, 172)},
                          (Brands.DMC.value, '640'): {'name': 'Very Dark Beige Gray', 'code': '640', 'rgb': (167, 159, 139)},
                          (Brands.DMC.value, '3866'): {'name': 'Ultra Very Light Mocha', 'code': '3866', 'rgb': (250, 246, 240)},
                          (Brands.DMC.value, '3865'): {'name': 'Very Light Mocha', 'code': '3865', 'rgb': (248, 247, 241)},
                          ...
                          (Brands.DMC.value, '963'): {'name': 'Ultra Very Light Dusty Rose', 'code': '963',
                                           'rgb': (255, 215, 226)},
                          (Brands.DMC.value, '3716'): {'name': 'Very Light Dusty Rose', 'code': '3716', 'rgb': (255, 189, 202)},
                          (Brands.DMC.value, '761'): {'name': 'Light Dusty Rose', 'code': '761', 'rgb': (255, 154, 172)},
                          (Brands.DMC.value, '760'): {'name': 'Medium Dusty Rose', 'code': '760', 'rgb': (245, 173, 173)},
                          (Brands.DMC.value, '3328'): {'name': 'Dark Dusty Rose', 'code': '3328', 'rgb': (238, 84, 110)},
                          (Brands.DMC.value, '309'): {'name': 'Very Dark Dusty Rose', 'code': '309', 'rgb': (214, 43, 91)},
                          ...
                          (Brands.DMC.value, '823'): {'name': 'Very Dark Navy Blue', 'code': '823', 'rgb': (33, 48, 99)},
                          (Brands.DMC.value, '3747'): {'name': 'Very Light Blue Violet', 'code': '3747', 'rgb': (211, 200, 232)},
                          (Brands.DMC.value, '3746'): {'name': 'Light Blue Violet', 'code': '3746', 'rgb': (188, 177, 213)},
                          (Brands.DMC.value, '3745'): {'name': 'Medium Blue Violet', 'code': '3745', 'rgb': (163, 151, 191)},
                          (Brands.DMC.value, '3744'): {'name': 'Dark Blue Violet', 'code': '3744', 'rgb': (132, 115, 175)},
                          (Brands.DMC.value, '333'): {'name': 'Very Dark Blue Violet', 'code': '333', 'rgb': (102, 73, 157)},
                          (Brands.DMC.value, '208'): {'name': 'Ultra Dark Blue Violet', 'code': '208', 'rgb': (72, 47, 109)},
                          ...
                          (Brands.ANCHOR.value, '111'): {'name': 'Medium Violet', 'code': '111', 'rgb': (132, 115, 175)},
                          ...
                          (Brands.COSMO.value, '1200'): {'name': 'Light Purple', 'code': '1200', 'rgb': (163, 151, 191)},
                          (Brands.COSMO.value, '1201'): {'name': 'Medium Purple', 'code': '1201', 'rgb': (132, 115, 175)},
